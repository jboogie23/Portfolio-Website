...
function enterKey(e) {
  ...
  if (pw) {
    ...
    if (e.keyCode == 13) {
      ...
      git = commands.length;
      addLine("ross.h.sanderson@gmail.com:~$ " + command.innerHTML, "no-animation", 0);
...
function commander(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "history":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="mailto:ross.h.sanderson@gmail.com">ross.h.sanderson@gmail.com</a>...', "color2", 80);
      newTab(email);
      break;
    case "clear":
      setTimeout(function() {
